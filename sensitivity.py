...
if __name__=='__main__':
    ...
    for i, X in enumerate(param_values):
        ...
        number_to_system = {1:"Natural Gas", 2:"Wood", 3:"Pellets", 4:"GSHP", 5:"ASHP", 6:"Oil", 7:"electric"}
        cooling_system = 'electric'  # this is fixed for now.
        ## Systeme
        ...
        Gebaeude_1 = se.Sim_Building(gebaeudekategorie_sia, regelung, windows, walls, roof, floor, energiebezugsflache,
        ...
        Gebaeude_1.run_rc_simulation(weatherfile_path=weatherfile_path, occupancy_path=occupancy_path,
